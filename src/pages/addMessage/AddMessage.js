...
import {Ionicons,Feather, Fontisto,FontAwesome5, Foundation, MaterialCommunityIcons} from 'react-native-vector-icons'
	...
	return (
		<View style={{flex:1, position:'relative'}}>
			...
			<View>
				...
				<View style={{flexDirection:'row', height:50, alignItems:'center', paddingLeft:15}}>
					<View >
						<Ionicons name='md-lock-closed' style={{fontSize:18, marginRight:30}} />
					</View>
					<View>
						<Text style={{fontSize:17}}>
				...
				<View style={{flexDirection:'row', height:50, alignItems:'center', paddingLeft:15}}>
					<View >
						<Foundation name='megaphone' style={{fontSize:18, marginRight:30}} />
					</View>
					<View>
						<Text style={{fontSize:17}}>
							Создать канал 
			...
			<View>
				...
				</View><View style={{flexDirection:'row', height:60, alignItems:'center'}}>
					<View style={{paddingLeft:15, marginRight:15}}>
					<Image style={{width:45, height:45, borderRadius:50}}source={image} />
					</View>
					<View >

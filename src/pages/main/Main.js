...
const Main = () => {
	...
	return (
		<View style={{ flex: 1, zIndex: 0 }}>
			...
			<Animated.View style={{ ...styles.menu__aninated__container, left: showMenuAnimated }}>
				<View style={styles.header__side__menu_left}>
					<View style={styles.menu__header__container}>
						<View style={styles.menu__header}>
							<View>
								<Image style={styles.menu__header__img} source={image} />
							</View>
							<View style={styles.menu__header__theme}>
					...
					<View style={styles.menu__main__container}>
						<View style={styles.menu__main__params__list}>
							<View style={styles.list__item__container}>
								<View style={styles.list__item}>
									<View style={{width:50}}>
										<FontAwesome5 name='user-friends' style={{ fontSize: 18}} />
									</View>
									<View>
							...
							<View style={styles.list__item__container}>
								<View style={styles.list__item}>
									<View style={{width:50}}>
										<FontAwesome5 name='user' style={{ fontSize: 18 }} />
									</View>
									<View>
										<Text style={{ fontSize: 14, fontWeight: '700' }}>
											Контакты

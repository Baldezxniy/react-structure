...
export const MainMain = () => {
	return (
		<View style={{ flexGrow: 1 }}>
				...
				<View style={styles.folders__item}>
					<View style={{ flexDirection: 'row', alignItems: 'center' }}>
						...
						<View style={styles.folders__item__bedge}>
							<Text style={{ paddingLeft: 5, paddingRight: 5, paddingTop: 1, paddingBottom: 1, fontSize: 11, }}>
								99+
							</Text>
						</View>
			...
			<Link to='/chat'>
				<View>
					<View style={[styles.row__container, { paddingLeft: 15, paddingRight: 15, paddingTop: 10, paddingBottom: 10, width: '100%' }]}>
						<View style={{ marginRight: 10 }} >
							<Image style={{ width: 50, height: 50, borderRadius: 50 }} source={image} />

						</View>
						<View style={{ flexGrow: 1 }} >
							<View style={[styles.row__container, { flexGrow: 1 }]}>
								<Text style={{ justifyContent: 'flex-start', fontSize: 16.5, fontWeight: '700', marginBottom: 5, color: '#fff', flexGrow: 1 }}>
									Вова
								</Text>
								<MaterialCommunityIcons name='check' style={{ fontSize: 18, justifyContent: 'center', marginRight: 5 }} />
								<Text style={{ color: 'rgba(0,0, 0, 0.5)', fontSize: 13, justifyContent: 'center' }}>
									10:10
								</Text>
							</View>
							...
							<View style={styles.row__container}>
								...
								<View style={{ borderRadius: 50, borderColor: 'rgba(0, 0, 0, 0.1)', borderStyle: 'solid', borderWidth: 1, padding: 6 }}>
									<AntDesign name='pushpin' style={{ transform: [{ rotate: '90deg' }], fontSize: 12 }} />
								</View>
							</View>
						</View>
					</View>
